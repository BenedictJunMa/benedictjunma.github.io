...
Hi! My name is Benedict Jun Ma (馬軍). I am currently a tenure-track Assistant Professor in the [Thrust of Intelligent Transportation](https://facultyprofiles.hkust-gz.edu.cn/faculty-personal-page/MA-BenedictJun/junm) at The Hong Kong University of Science and Technology (Guangzhou), where I am leading the [**Intelligent Logistics and Supply Chain Analytics (iLSCA) Lab**](https://benedictjunma.github.io/people/).  My research explores how emerging technologies enhance the modeling, optimization, and control of systems in transportation, logistics, and supply chains. Specifically, my research directions include Smart warehousing and logistics, AI-driven human-robot collaboration, and Human-AI collective intelligence.

**I am actively seeking self-motivated and hardworking PhD/MPhil students to work on various research topics in my group.** Candidates with a strong background in Computer Science, Automation, Industrial Engineering, Transportation, or Applied Mathematics are encouraged to apply, expected to enroll in Fall 2027. Regular full-time PhD/MPhil students are normally considered eligible to receive a Postgraduate Scholarship (PGS). I also welcome research assistants and visiting students to work together and provide adequate financial support.

Prior to joining HKUST(GZ), I was a Postdoctoral Associate in the [Center for Transportation & Logistics (CTL)](https://ctl.mit.edu/), Massachusetts Institute of Technology. I was also affiliated with the [MIT Supply Chain Management](https://scm.mit.edu/) and the [MIT Digital Supply Chain Lab](https://digitalsc.mit.edu). I earned my PhD in the Department of Data and Systems Engineering from The University of Hong Kong, supervised by [Prof. Yong-Hong Kuo](https://www.dase.hku.hk/people/y-h-kuo) and [Prof. George Q. Huang](https://www.polyu.edu.hk/ise/people/academic-staff/george-huang/). 
